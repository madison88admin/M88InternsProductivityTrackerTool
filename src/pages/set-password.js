      ...
      <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8"
          ...
          <div id="state-form" class="hidden">
            <h2 class="text-xl font-bold text-neutral-900 mb-1">Set Your Password</h2>
            <p id="form-greeting" class="text-sm text-neutral-500 mb-6"></p>

            <form id="set-password-form" class="space-y-5" novalidate>
    ...
    try {
      ...
      if (!data.valid) {
        const messages = {
          ...
          expired:   'This invite link has expired (links are valid for 5 minutes).',
        };
